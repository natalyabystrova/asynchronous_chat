...
import binascii
import os
from constantsnutils.metaclasses import ServerMaker
from constantsnutils.descryptors import Port
from constantsnutils.variables import *
from constantsnutils.utils import send_message, make_message
from constantsnutils.decos import login_required
                ...
                for client_with_message in recv_data_lst:
                    try:
                        self.process_client_message(
                            make_message(client_with_message), client_with_message)
