...
from lesson_4.server.stat_window import StatWindow
from lesson_4.server.config_window import ConfigWindow
from lesson_4.server.add_user import RegisterUser
from lesson_4.server.remove_user import DelUserDialog
