...
class TestServer(unittest.TestCase):
    ...
    def test_unknown_user(self):
        self.assertEqual(server.process_client_message(
            {constants.ACTION: constants.PRESENCE, constants.TIME: 1.1, constants.USER: {constants.ACCOUNT_NAME: 'Guest1'}}), self.err_dict)

    def test_ok_check(self):
        self.assertEqual(server.process_client_message(
            {constants.ACTION: constants.PRESENCE, constants.TIME: 1.1, constants.USER: {constants.ACCOUNT_NAME: 'Guest'}}), self.ok_dict)
