...
class ServerStorage:
    ...
    def __init__(self):
        ...
        map_registry.map_imperatively(self.AllUsers, users_table)
        map_registry.map_imperatively(self.ActiveUsers, active_users_table)
        map_registry.map_imperatively(self.LoginHistory, user_login_history)
